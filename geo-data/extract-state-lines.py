"""
This module forms a topojson with the US state lines and provinces around the world.
"""
...
dataset_name = "ne_50m_admin_1_states_provinces_lines"
input_path = os.path.join(script_dir, dataset_name, dataset_name + ".shp")
output_path = os.path.join(script_dir, "states-provinces-lines.json")
