...
class WelcomeScreenTest {
    ...
    fun testShowAccountNumber() {
        // Arrange
        val mockAccountNumber = "1111 2222 3333 4444"
        composeTestRule.setContent {
            WelcomeScreen(
                showSitePayment = true,
                uiState = WelcomeUiState(accountNumber = mockAccountNumber),
                viewActions = MutableSharedFlow(),
                onSitePaymentClick = {},
                onRedeemVoucherClick = {},
                onSettingsClick = {},
        ...
        // Assert
        composeTestRule.apply { onNodeWithText(mockAccountNumber).assertExists() }
    }
