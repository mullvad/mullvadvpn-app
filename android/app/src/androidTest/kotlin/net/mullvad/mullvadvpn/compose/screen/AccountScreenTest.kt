            ...
            AccountScreen(
                ...
                uiState =
                    AccountUiState.default()
                        .copy(dialogState = AccountScreenDialogState.PurchaseComplete),
                viewActions = MutableSharedFlow<AccountViewModel.ViewAction>().asSharedFlow(),
                enterTransitionEndAction = MutableSharedFlow<Unit>().asSharedFlow()
            )
        }
    ...
    fun testShowVerificationErrorDialog() {
        ...
        composeTestRule.setContent {
            AccountScreen(
                ...
                uiState =
                    AccountUiState.default()
                        .copy(dialogState = AccountScreenDialogState.VerificationError),
                viewActions = MutableSharedFlow<AccountViewModel.ViewAction>().asSharedFlow(),
                enterTransitionEndAction = MutableSharedFlow<Unit>().asSharedFlow()
            )
        }
    ...
    fun testShowBillingErrorDialog() {
        ...
        composeTestRule.setContent {
            AccountScreen(
                ...
                uiState =
                    AccountUiState.default()
                        .copy(dialogState = AccountScreenDialogState.BillingError),
                viewActions = MutableSharedFlow<AccountViewModel.ViewAction>().asSharedFlow(),
                enterTransitionEndAction = MutableSharedFlow<Unit>().asSharedFlow()
            )
        }
