 ...
 *
 * The file contains all of the Material 3 typography classes,
 * only some are used within the MullvadVPN Android app.
 *
 * Typography used within the app:
 * - headlineLarge -> Used for titles, country and city in connection info.
 *          ex: VPN settings
 * - titleLarge -> Used for parent list-items.
 *          ex: DNS content blockers
 * - titleMedium -> Used for child and child-child list-items.
 *          ex: Automatic option in Tunnel protocol
 * - bodyMedium -> Used for body text.
 *          ex: Info text in dialogs
 * - labelLarge -> Used for button labels.
 *          ex: Got it!
 * - labelSmall -> Used for smaller descriptions under list-items and filters.
 *          ex: Filtered:
 */
...
internal val MullvadMaterial3Typography =
    Typography(
        ...
        titleLarge = //List-items (parent) + Button labels
        TextStyle(
            fontFamily = FontFamily.SansSerif,
