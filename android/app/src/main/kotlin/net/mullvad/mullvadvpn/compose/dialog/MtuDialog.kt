...
fun MtuDialog(
    ...
    val isValidMtu = mtuValue.value.toIntOrNull()?.isValidMtu() == true
        ...
        content = {
            Column(
                ...
                Box(
                    ...
                    MtuTextField(
                        value = mtuValue.value,
                        onValueChanged = { newMtuValue -> mtuValue.value = newMtuValue },
                        onFocusChange = {},
                        onSubmit = { newMtuValue ->
                            if (newMtuValue.toIntOrNull()?.isValidMtu() == true) {
                                onSave(newMtuValue.toIntOrNull() ?: 0)
                            }
                        },
                        isEnabled = true,
                ...
                ActionButton(
                    ...
                    onClick = { onSave(mtuValue.value.toIntOrNull() ?: 0) },
                )
