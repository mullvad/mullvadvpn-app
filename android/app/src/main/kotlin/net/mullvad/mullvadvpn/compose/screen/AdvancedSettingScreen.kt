...
//                        }, { viewModel.onSubmitMtu() })
                ...
                if (uiState.isCustomDnsEnabled) {
                    items(items = uiState.customDnsList) {
                        DnsCell(
                            DnsCellUiState(ip = it, isEditMode = uiState.isInEditMode(it)),
                            { onDnsCellClicked(uiState.customDnsList.indexOf(it)) },
                            { /*it.removeAt(index)*/ },
                            {},
                    ...
                    item {
                        DnsCell(
                            DnsCellUiState(isEditMode = uiState.isInEditMode(null)),
                            { onDnsCellClicked(uiState.customDnsList.size) },
