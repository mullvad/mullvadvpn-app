...
fun Resources.format(accountExpiry: DateTime): String {
    val remainingTime = Duration(DateTime.now(), accountExpiry)

    return format(this, accountExpiry, remainingTime)
}

private fun format(resources: Resources, accountExpiry: DateTime, remainingTime: Duration): String {
