...
open class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO : this part is to test dialog, remove later
        changesViewModel.resetShouldShowChanges()
    ...
    private fun checkAndShowChanges() {
        if (changesViewModel.shouldShowChanges()) {
            findViewById<ComposeView>(R.id.compose_view).apply {
                ...
                setContent {
                    ScaffoldWithTopBar(
                        ...
                        onSettingsClicked = {},
                        content = {
                            ChangesListScreen(viewModel = changesViewModel) {
