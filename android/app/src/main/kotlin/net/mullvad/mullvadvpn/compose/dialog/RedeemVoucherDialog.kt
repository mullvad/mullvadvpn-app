...
private fun PreviewRedeemVoucherDialogSuccess() {
    AppTheme {
        RedeemVoucherDialog(
            uiState = VoucherDialogUiState("", VoucherDialogState.Success("Success message")),
            onVoucherInputChange = {},
            onRedeem = {},
            onDismiss = {}
        )
        ...
        text = {
            Column(
                ...
                if (uiState.voucherViewModelState is VoucherDialogState.Success) {
                    ...
                    Text(
                        text = uiState.voucherViewModelState.message,
                        modifier =
                            Modifier.padding(
                                    start = Dimens.smallPadding,
...
private fun vouchersVisualTransformation(text: AnnotatedString, maxSize: Int): TransformedText {
    ...
    var out = ""
    val transformedMaxSize = maxSize + maxSize / ACCOUNT_TOKEN_CHUNK_SIZE
