...
private fun PreviewRedeemVoucherDialogSuccess() {
    AppTheme {
        RedeemVoucherDialog(
            uiState = VoucherDialogUiState("", VoucherDialogState.Success(0)),
            onVoucherInputChange = {},
            onRedeem = {},
            onDismiss = {}
        )
        ...
        text = {
            Column(
                ...
                if (uiState.voucherViewModelState is VoucherDialogState.Success) {
                    ...
                    val message =
                        if (days > 60) {
                            stringResource(R.string.months_added_to_your_account, days / 30)
                        } else if (days == 0) {
                            stringResource(R.string.less_than_one_day_added_to_your_account)
                        } else {
                            pluralStringResource(
                                id = R.plurals.days_added_to_your_account,
                                count = days,
                                days
                            )
                        }
