...
import net.mullvad.mullvadvpn.lib.repository.WidgetSettingsState.Companion.PREF_KEY
import net.mullvad.mullvadvpn.lib.ui.resource.R
import net.mullvad.mullvadvpn.widget.WidgetProvider
import net.mullvad.mullvadvpn.widget.WidgetTheme
...
class MullvadAppWidget : GlanceAppWidget() {
    ...
    private fun Settings?.daitaEnabled() =
        this?.tunnelOptions?.daitaSettings?.enabled == true
    ...
    private fun Settings?.inTunnelIpv6Enabled() =
        this?.tunnelOptions?.enableIpv6 == true
    ...
    private fun Settings?.quantumResistantState() =
        this?.tunnelOptions?.quantumResistant ?: QuantumResistantState.On
