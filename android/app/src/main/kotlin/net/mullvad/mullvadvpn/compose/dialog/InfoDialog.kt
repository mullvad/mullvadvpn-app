...
fun ContentBlockersInfo(onDismiss: () -> Unit) {
    InfoDialog(stringResource(id = R.string.dns_content_blockers_info), onDismiss)
}

@Composable
fun MalwareInfo(onDismiss: () -> Unit) {
    InfoDialog(stringResource(id = R.string.malware_info), onDismiss)
}

@Composable
fun InfoDialog(info: String, onDismiss: () -> Unit) {
    AlertDialog(
