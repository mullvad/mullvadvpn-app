...
fun ExpandableComposeCell(
    title: String,
    expandState: Boolean,
    isTitleEnable: Boolean = true,
    onCellClicked: (Boolean) -> Unit = {},
    onInfoClicked: (() -> Unit)? = null
) {
    val titleModifier = Modifier.alpha(getTitleAlpha(isTitleEnable))
...
private fun getTitleAlpha(isEnable: Boolean): Float {
    return if (isEnable) MullvadNotTransparent else MullvadTransparent20
}
