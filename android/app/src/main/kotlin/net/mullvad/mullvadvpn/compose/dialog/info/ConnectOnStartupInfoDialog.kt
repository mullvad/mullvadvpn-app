...
fun ConnectOnStartupInfo(navigator: DestinationsNavigator) {
    ...
    /*InfoDialog(message = buildString {
        appendLine(textResource(R.string.connect_on_start_info_first))
        appendLine()
        appendLine(textResource(R.string.connect_on_start_info_second))
        appendLine()
        appendLine(textResource(R.string.connect_on_start_info_third))
    }, onDismiss = { context.openAppDetailsSettings() })*/
