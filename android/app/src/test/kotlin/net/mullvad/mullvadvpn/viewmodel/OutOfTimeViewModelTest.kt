...
class OutOfTimeViewModelTest {
    ...
    @Test
    fun `given onSitePaymentClick uiSideEffect should emit OpenAccountView`() = runTest {
        // Arrange
    ...
    @Test
    fun `given OutOfTimeUseCase returns false uiSideEffect should emit OpenConnectScreen`() =
        runTest {
            // Arrange
