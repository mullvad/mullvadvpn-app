...
class VpnSettingsViewModelTest {
    ...
    @Test
    fun `quantumResistant should be Off in uiState by default`() = runTest {
        // Arrange
    ...
    @Test
    fun `given SettingsRepository emits quantumResistant On uiState should emit quantumResistant On`() =
        runTest {
