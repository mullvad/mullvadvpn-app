...
class VoucherDialogViewModelTest {
    ...
    @Test
    fun `given invocation of onRedeem with invalid voucher uiState should emit Error`() = runTest {
        val voucher = DUMMY_INVALID_VOUCHER
        val dummyStringResource = DUMMY_STRING_RESOURCE
    ...
    @Test
    fun `given invocation of onRedeem with valid voucher uiState should emit Success`() = runTest {
