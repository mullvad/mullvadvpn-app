...
class ReportProblemViewModelTest {
    ...
    @Test
    fun `given sendReport returns CollectLog error uiState should emit sendingState with CollectLog error`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `given sendReport returns SendReport error uiState should emit sendingState with SendReport error`() =
        runTest {
            // Arrange
            coEvery { mockMullvadProblemReport.sendReport(any()) } returns
    ...
    @Test
    fun `given sendReport with no email returns Success uiState should emit sendingState with Success`() =
        runTest {
            // Arrange
            coEvery { mockMullvadProblemReport.sendReport(any()) } returns
    ...
    @Test
    fun `given sendReport with email returns Success uiState should emit sendingState with Success`() =
        runTest {
            // Arrange
            coEvery { mockMullvadProblemReport.collectLogs() } returns true
            coEvery { mockMullvadProblemReport.sendReport(any()) } returns
