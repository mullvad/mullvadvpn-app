...
class LoginViewModelTest {
    ...
    @Test
    fun `given login call returns InvalidAccount loginState should be InvalidCredentials`() =
        runTest {
    ...
    @Test
    fun `given login call returns MaxDevicesReached uiSideEffect should emit TooManyDevices`() =
        runTest {
            turbineScope {
                // Arrange
                val uiStates = loginViewModel.uiState.testIn(backgroundScope)
    ...
    @Test
    fun `given login call returns RpcError loginState should be Error`() = runTest {
        loginViewModel.uiState.test {
            // Arrange
    ...
    @Test
    fun `given login call returns OtherError loginState should be error`() = runTest {
        loginViewModel.uiState.test {
            // Arrange
