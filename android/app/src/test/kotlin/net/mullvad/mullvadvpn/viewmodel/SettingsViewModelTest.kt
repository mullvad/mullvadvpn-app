...
class SettingsViewModelTest {
    ...
    @Test
    fun `by default uiState should return isLoggedIn false`() = runTest {
        // Act, Assert
        viewModel.uiState.test { assertEquals(false, awaitItem().isLoggedIn) }
    }

    @Test
    fun `given AppVersionInfoCache returns isOutdated false uiState should return isUpdateAvailable false`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `given AppVersionInfoCache returns isSupported false uiState should return isUpdateAvailable true`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `given AppVersionInfoCache returns isOutdated true uiState should return isUpdateAvailable true`() =
        runTest {
            // Arrange
            every { mockAppVersionInfoCache.isSupported } returns true
