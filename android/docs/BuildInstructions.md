...
1. Build the app with the container: `../building/containerized-build.sh android --skip-clean-check`
...
1. Build the app locally without the container: `./build.sh --skip-clean-check`
