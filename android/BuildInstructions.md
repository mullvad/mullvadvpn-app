...
#### 6. Download wireguard-go submodule
Run the following command to download wireguard-go submodule: `git submodule update --init --recursive --depth=1 wireguard-go-rs`
