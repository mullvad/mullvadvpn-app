...
If you want to run tests that make use of APIs hosted at Mullvad HQ you need to set `ENABLE_ACCESS_TO_LOCAL_API_TESTS` to true in `e2e.properties` or pass it as a command line argument when launching tests.
