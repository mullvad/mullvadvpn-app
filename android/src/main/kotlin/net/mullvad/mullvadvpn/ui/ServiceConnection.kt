...
class ServiceConnection(
    private val connection: net.mullvad.mullvadvpn.service.ServiceConnection,
    ...
    val daemon = connection.daemon
    val connectionProxy = connection.connectionProxy
    val connectivityListener = connection.connectivityListener
