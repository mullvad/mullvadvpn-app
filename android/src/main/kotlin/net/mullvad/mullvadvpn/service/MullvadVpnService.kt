...
class MullvadVpnService : TalpidVpnService() {
    ...
    private var connectionNotifier = EventNotifier<ServiceConnection?>(null)
    ...
    inner class LocalBinder : Binder() {
        ...
        val connectionNotifier
            get() = this@MullvadVpnService.connectionNotifier
        val connectionProxy
    ...
    private fun startDaemon() = GlobalScope.async(Dispatchers.Default) {
        ...
        connectionNotifier.notify(ServiceConnection(daemon, connectionProxy, connectivityListener))
    ...
    private fun stop() {
        ...
        connectionNotifier.notify(null)
