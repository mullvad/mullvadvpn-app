...
class MultihopMigrationViewModelTest {
    ...
    fun `when calling setEntryLocation should call repository setEntryLocation`() = runTest {
        // Arrange
        coEvery {
            mockWireguardConstraintsRepository.setEntryLocation(any<Constraint<RelayItemId>>())
        } returns Unit.right()
        val multihopMigrationData =
            MultihopMigrationData(
    ...
    fun `when calling setMultihopMode should call repository setMultihopMode`() = runTest {
        // Arrange
        coEvery { mockWireguardConstraintsRepository.setMultihop(any()) } returns Unit.right()
        val multihopMigrationData =
            MultihopMigrationData(
        ...
        // Assert
        coVerify { mockWireguardConstraintsRepository.setMultihop(mode) }
    }
