...
private val excludedApps =
    listOf(
        AppData(
            packageName = AppId("my.package.a"),
            name = "TitleA",
            iconRes = R.drawable.icon_android,
        ),
        AppData(
            packageName = AppId("my.package.b"),
            name = "TitleB",
            iconRes = R.drawable.icon_android,
        ),
        AppData(
            packageName = AppId("my.package.c"),
...
private val includedApps =
    listOf(
        AppData(
            packageName = AppId("my.package.d"),
            name = "TitleD",
            iconRes = R.drawable.icon_android,
        ),
        AppData(
            packageName = AppId("my.package.e"),
