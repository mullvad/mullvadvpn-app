...
val FilterSelectedActive: ImageVector
    get() {
        if (_FilterSelectedActive != null) {
            return _FilterSelectedActive!!
        }
        _FilterSelectedActive =
            ImageVector.Builder(
                    name = "FilterSelectedActive",
                    defaultWidth = 24.dp,
                    defaultHeight = 24.dp,
                    viewportWidth = 24f,
                    viewportHeight = 24f,
...
@Suppress("ObjectPropertyName") private var _FilterSelectedActive: ImageVector? = null
