...
class BillingPaymentRepository(
    ...
    private suspend fun getBillingProducts(
        ...
        return when {
            ...
            result.billingResult.responseCode == BillingResponseCode.DEVELOPER_ERROR ->
                PaymentAvailability.Error.DeveloperError
            result.billingResult.responseCode == BillingResponseCode.FEATURE_NOT_SUPPORTED ->
                PaymentAvailability.Error.FeatureNotSupported
            result.billingResult.responseCode == BillingResponseCode.ITEM_UNAVAILABLE ->
