...
- The first four connection attempts will use Wireguard.
  - The first two of these attempts will connect to a Wireguard relay on a random port.
  - The third attempt will connect to a Wireguard relay on port 443
  - The fourth attempt will connect to a Wireguard relay over IPv6 (if IPv6 is configured on the host)
- The fifth-to-eighth attempt will alternate between Wireguard and OpenVPN
