...
impl Environment {
    ...
    /// supports.
    fn get_arch() -> Result<Architecture, Error> {
        ...
        let arch = match arch {
            talpid_platform_metadata::Architecture::X86 => Architecture::X86,
            talpid_platform_metadata::Architecture::Arm64 => Architecture::Arm64,
        };
