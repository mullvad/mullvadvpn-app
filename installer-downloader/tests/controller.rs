...
pub struct FakeAppControllerProvider;

impl AppControllerProvider for FakeAppControllerProvider {
    type Delegate = FakeAppDelegate;
    type DownloaderFactory = FakeAppDownloaderFactory;
...
impl AppDownloaderFactory for FakeAppDownloaderFactory {
...
async fn test_fetch_version() {
    ...
    initialize_controller_for_provider::<FakeAppControllerProvider>(&mut delegate);
