...
pub mod builder {
    ...
    /// Internal builder state for a [`RelayConstraint`] paramterized over the
    ...
    ///
    /// - The type paramter `VpnProtocol` keeps track of which VPN protocol that
    ...
    pub mod wireguard {
        ...
        ///
        /// - The type paramter `Multihop` keeps track of the state of multihop.
        ...
        /// otherwise unopiniated defaults.
    ...
    pub mod openvpn {
        ...
        ///
        /// - The type paramter `TransportPort` keeps track of which
