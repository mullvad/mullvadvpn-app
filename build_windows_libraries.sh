...
# wfpctl. Set this to "Release" to build release versions.
CPP_BUILD_MODES=${CPP_BUILD_MODES:-"Debug"}
# Override this variable to set different target platforms for wfpctl. Add
# "x86" to build win32 versions.
