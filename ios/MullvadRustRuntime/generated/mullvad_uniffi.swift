...
public protocol ApiContextProtocol: AnyObject, Sendable {
    ...
    func getRelays(retryStrategy: RetryStrategy, digest: String?, digestTimestamp: Int64?)  -> RequestCancelHandle
...
open func getRelays(retryStrategy: RetryStrategy, digest: String?, digestTimestamp: Int64?) -> RequestCancelHandle  {
    return try!  FfiConverterTypeRequestCancelHandle_lift(try! rustCall() {
    uniffi_mullvad_ios_fn_method_apicontext_get_relays(
            self.uniffiCloneHandle(),
        FfiConverterTypeRetryStrategy_lower(retryStrategy),
        FfiConverterOptionString.lower(digest),
        FfiConverterOptionInt64.lower(digestTimestamp),$0
    )
})
}
...
open class RetryStrategy: RetryStrategyProtocol, @unchecked Sendable {
     ...
     */
public static func constant(maxRetries: UInt64, delaySec: UInt64) -> RetryStrategy  {
    return try!  FfiConverterTypeRetryStrategy_lift(try! rustCall() {
    uniffi_mullvad_ios_fn_constructor_retrystrategy_constant(
     ...
     */
public static func exponential(maxRetries: UInt64, initialSec: UInt64, factor: UInt32, maxDelaySec: UInt64) -> RetryStrategy  {
    return try!  FfiConverterTypeRetryStrategy_lift(try! rustCall() {
    uniffi_mullvad_ios_fn_constructor_retrystrategy_exponential(
        FfiConverterUInt64.lower(maxRetries),
     ...
     */
public static func never() -> RetryStrategy  {
    return try!  FfiConverterTypeRetryStrategy_lift(try! rustCall() {
    uniffi_mullvad_ios_fn_constructor_retrystrategy_never($0
    )
})
}
...
public enum ApiResponse: Equatable, Hashable, Codable {
    
    case body(body: Data, statusCode: UInt16, sigsumDigest: String?, sigsumTimestamp: Int64?
    )
    case error(statusCode: UInt16, errorDescription: String?, serverResponseCode: String?
    )
...
#if compiler(>=6)
extension ApiResponse: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeApiResponse: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ApiResponse {
        ...
        case 1: return .body(body: try FfiConverterData.read(from: &buf), statusCode: try FfiConverterUInt16.read(from: &buf), sigsumDigest: try FfiConverterOptionString.read(from: &buf), sigsumTimestamp: try FfiConverterOptionInt64.read(from: &buf)
        )
        
        case 2: return .error(statusCode: try FfiConverterUInt16.read(from: &buf), errorDescription: try FfiConverterOptionString.read(from: &buf), serverResponseCode: try FfiConverterOptionString.read(from: &buf)
        )
    ...
    public static func write(_ value: ApiResponse, into buf: inout [UInt8]) {
        ...
        case let .body(body,statusCode,sigsumDigest,sigsumTimestamp):
            writeInt(&buf, Int32(1))
            FfiConverterData.write(body, into: &buf)
            FfiConverterUInt16.write(statusCode, into: &buf)
            FfiConverterOptionString.write(sigsumDigest, into: &buf)
            FfiConverterOptionInt64.write(sigsumTimestamp, into: &buf)
            
        
        case let .error(statusCode,errorDescription,serverResponseCode):
            writeInt(&buf, Int32(2))
            FfiConverterUInt16.write(statusCode, into: &buf)
            FfiConverterOptionString.write(errorDescription, into: &buf)
            FfiConverterOptionString.write(serverResponseCode, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeApiResponse_lift(_ buf: RustBuffer) throws -> ApiResponse {
    return try FfiConverterTypeApiResponse.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeApiResponse_lower(_ value: ApiResponse) -> RustBuffer {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mullvad_ios_checksum_method_apicontext_get_relays() != 15144) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_mullvad_ios_checksum_constructor_retrystrategy_exponential() != 52804) {
        return InitializationResult.apiChecksumMismatch
    }
