...
public enum ApiResponse: Equatable, Hashable, Codable {
    ...
    case body(body: Data, etag: String?, statusCode: UInt16
    )
...
public struct FfiConverterTypeApiResponse: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ApiResponse {
        ...
        case 1: return .body(body: try FfiConverterData.read(from: &buf), etag: try FfiConverterOptionString.read(from: &buf), statusCode: try FfiConverterUInt16.read(from: &buf)
        )
    ...
    public static func write(_ value: ApiResponse, into buf: inout [UInt8]) {
        ...
        case let .body(body,etag,statusCode):
            writeInt(&buf, Int32(1))
            FfiConverterData.write(body, into: &buf)
            FfiConverterOptionString.write(etag, into: &buf)
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mullvad_ios_checksum_constructor_retrystrategy_exponential() != 26490) {
        return InitializationResult.apiChecksumMismatch
    }
