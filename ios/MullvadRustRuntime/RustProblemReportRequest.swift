...
final public class RustProblemReportRequest {
    ...
    private let request: ProblemReportRequest
    ...
    public func toRust() -> SwiftProblemReportRequest {
        SwiftProblemReportRequest(
            address: request.address.toCStringPointer(),
            message: request.message.toCStringPointer(),
            log: request.log.toCStringPointer(),
