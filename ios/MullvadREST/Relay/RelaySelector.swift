...
public enum RelaySelector {
    ...
    public enum WireGuard {
         ...
         */
        public static func evaluateForSingleHop(
        ...
        /**
         Filters relay list using given constraints and selects random relays for entry and exit relay.
         Throws an error if there are no relays satisfying the given constraints.
         */
        public static func evaluateForMultiHop(
            by constraints: RelayConstraints,
            in relaysResponse: REST.ServerRelaysResponse,
            numberOfFailedAttempts: UInt
        ) throws -> RelaySelectorResult {
            ...
            //
            // TODO: Find the best match for the entry
            //
        }
...
extension RelaySelector {
    ...
    private static func applyPortConstraint(
