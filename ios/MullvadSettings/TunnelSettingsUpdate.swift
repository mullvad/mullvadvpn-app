...
public enum TunnelSettingsUpdate {
    ...
    case tunnelQuantumResistance(WireGuardTunnelQuantumResistanceSettings)
}
...
extension TunnelSettingsUpdate {
    public func apply(to settings: inout LatestTunnelSettings) {
        ...
        case let .tunnelQuantumResistance(newQuantumResistance):
            settings.wireGuardTunnelQuantumResistance = newQuantumResistance
        }
    }
    ...
    public var subjectName: String {
        ...
        case .tunnelQuantumResistance: "quantum resistance"
        }
    }
}
