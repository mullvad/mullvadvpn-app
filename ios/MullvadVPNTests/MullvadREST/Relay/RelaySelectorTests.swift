...
class RelaySelectorTests: XCTestCase {
    ...
    func testCountryConstraint() throws {
        ...
        let result = try RelaySelector.WireGuard.evaluateForSingleHop(
            by: constraints,
            in: sampleRelays,
    ...
    func testRandomPortSelectionWithFailedAttempts() throws {
        ...
        var result = try RelaySelector.WireGuard.evaluateForSingleHop(
            by: constraints,
            in: sampleRelays,
            numberOfFailedAttempts: 0
        )
        ...
        result = try RelaySelector.WireGuard.evaluateForSingleHop(
            by: constraints,
            in: sampleRelays,
