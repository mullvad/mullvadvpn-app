...
public enum BlockedStateReason: String, Codable, Equatable, Sendable {
    ...
    public func recoverableError() -> Bool {
        switch self {
        case .deviceLocked, .multihopEntryEqualsExit, .outdatedSchema, .noRelaysSatisfyingConstraints, .noRelaysSatisfyingPortConstraints, .noRelaysSatisfyingDaitaConstraints, .noRelaysSatisfyingFilterConstraints, .noRelaysSatisfyingObfuscationSettings, .readSettings, .invalidRelayPublicKey:
            return true
