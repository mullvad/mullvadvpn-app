...
/// Abstracts the packet tunnel provider capabilities needed by GotaTun.
///
...
public protocol GotaTunProviderDelegate: Sendable {
    ...
    /// Create a network path observer bound to the given queue.
