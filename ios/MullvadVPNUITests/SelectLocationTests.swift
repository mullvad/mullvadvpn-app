...
class SelectLocationTests: LoggedInWithTimeUITestCase {
    func testEnableDAITA() {
        ...
        XCTAssertTrue(app.staticTexts[AccessibilityIdentifier.daitaFilterPillCell.asString].exists)
    }
    ...
    func testEnableShadowsocksObfuscation() {
        ...
        XCTAssertTrue(app.staticTexts[AccessibilityIdentifier.obfuscationFilterPillCell.asString].exists)
    }
}
