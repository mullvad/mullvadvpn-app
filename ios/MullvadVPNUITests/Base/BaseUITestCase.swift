...
class BaseUITestCase: XCTestCase {
    ...
    static let testsDefaultCountry = "Sweden"

    /// Default city to use in tests
    static let testsDefaultCity = "Gothenburg"
    ...
    /// Return borrowed account with time after done using it. If the borrowed account is a temporary account created with partner API it will be deleted.
