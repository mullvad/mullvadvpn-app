...
class LeakTests: LoggedInWithTimeUITestCase {
    ...
    func testNoLeak() throws {
        ...
        FirewallClient().createRule(try FirewallRule.makeBlockAllTrafficRule(toIPAddress: targetIPAddress))
        startPacketCapture()
        ...
        capturedStreams = PacketCaptureClient.cutStreams(streams: capturedStreams, secondsStart: 8, secondsEnd: 1)
