...
/// An error returned by `CheckDeviceOperation` in the event when device is no longer logged in.
...
/// A protocol that formalizes device state accessor dependency used by `CheckDeviceOperation`.
