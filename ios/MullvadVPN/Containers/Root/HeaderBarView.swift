...
class HeaderBarView: UIView {
    ...
    let accountButton: SquareHitButton = {
    ...
    let settingsButton: SquareHitButton = {
    ...
    class func makeHeaderBarButton(with image: UIImage?) -> SquareHitButton {
        ...
        let barButton = SquareHitButton(type: .system)
