    ...
    private struct WhenNeededPage: View {
        var body: some View {
            VStack(alignment: .leading) {
                Text("When needed")
                    .fontWeight(.bold)
                Text("Not all our locations/servers support every feature in the app. "
    ...
    private struct WhenNeededAlert: View {
        var body: some View {
            VStack(alignment: .leading, spacing: 16) {
                Text("Not all our locations/servers support every feature in the app. If your selected"
