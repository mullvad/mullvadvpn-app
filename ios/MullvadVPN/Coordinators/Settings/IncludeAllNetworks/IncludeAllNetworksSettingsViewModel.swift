...
class IncludeAllNetworksSettingsViewModelImpl: IncludeAllNetworksSettingsViewModel {
    ...
    var settings: InclueAllNetworksSettings
    ...
    init(tunnelManager: TunnelManager) {
        ...
        settings = InclueAllNetworksSettings(
            includeAllNetworksState: tunnelManager.settings.includeAllNetworks ? .on : .off,
            localNetworkSharingState: tunnelManager.settings.localNetworkSharing ? .on : .off,
            consent: tunnelManager.settings.includeAllNetworksConsent
        )
...
class MockIncludeAllNetworksTunnelSettingsViewModel: IncludeAllNetworksSettingsViewModel {
    ...
    var showEnableNotificationsAlert: Bool
    var showReconsiderNotificationsAlert: Bool

    init(settings: InclueAllNetworksSettings = InclueAllNetworksSettings()) {
        includeAllNetworksState = settings.includeAllNetworksState
        localNetworkSharingState = settings.localNetworkSharingState
        consent = settings.consent

        showEnableNotificationsAlert = false
        showReconsiderNotificationsAlert = false
    }
}
