...
class MethodSettingsViewController: UITableViewController {
    ...
    private func dequeueCell(at indexPath: IndexPath, for itemIdentifier: MethodSettingsItemIdentifier)
        ...
        case .validationError:
            configureValidationError(cell, itemIdentifier: itemIdentifier)
        case .testingStatus:
    ...
    private func configureValidationError(_ cell: UITableViewCell, itemIdentifier: MethodSettingsItemIdentifier) {
    ...
    func updateDataSourceWithContentValidationErrors() {
        ...
        let itemsToReload: [MethodSettingsItemIdentifier] = switch subject.value.method {
        case .direct, .bridges:
            []
        case .shadowsocks:
            MethodSettingsItemIdentifier.allShadowsocksItems
        case .socks5:
            MethodSettingsItemIdentifier.allSocksItems(authenticate: subject.value.socks.authenticate)
        }
    ...
    private func validateInput() {
        ...
        saveBarButton.isEnabled = inputValidationErrors.isEmpty
    }
    ...
    private func onTest() {
        ...
        guard contentValidationErrors.isEmpty else {
            updateDataSourceWithContentValidationErrors()
            return
        }
