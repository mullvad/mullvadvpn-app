    ...
    func navigateToCustomLists(nodes: [LocationNode]) {
        let actionSheet = UIAlertController(
            title: NSLocalizedString(
                "ACTION_SHEET_TITLE", value: "Custom lists", comment: ""
            ),
            message: nil,
        ...
        let addCustomListAction = UIAlertAction(
            title: NSLocalizedString(
                "ACTION_SHEET_ADD_LIST_BUTTON", value: "Add new list", comment: ""
            ),
            style: .default,
        ...
        let editAction = UIAlertAction(
            title: NSLocalizedString(
                "ACTION_SHEET_EDIT_LISTS_BUTTON", value: "Edit lists", comment: ""
            ),
            style: .default,
            handler: { [weak self] _ in
