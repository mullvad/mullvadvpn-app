...
final class WelcomeCoordinator: Coordinator, Presentable {
    ...
    func start(animated: Bool) {
        guard case var .loggedIn(storedAccountData, storedDeviceData) = tunnelManager.deviceState else {
            return
        }
        let interactor = WelcomeInteractor(deviceData: storedDeviceData, accountData: storedAccountData)
