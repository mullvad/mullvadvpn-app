...
class AutomaticKeyRotationManager {
    ...
    {
        let newPrivateKeyMetadata = PrivateKeyMetadata()
    ...
    private func updateTunnelSettings(privateKeyMetadata: PrivateKeyMetadata, addresses: WireguardAssociatedAddresses) -> Result<TunnelSettings, Error> {
