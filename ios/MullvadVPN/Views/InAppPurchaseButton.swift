...
class InAppPurchaseButton: AppButton {
    ...
    override func layoutSubviews() {
        ...
        self.activityIndicator.frame = getActivityIndicatorRect(forContentRect: contentRect)
    }

    private func getTitleRect(forContentRect contentRect: CGRect) -> CGRect {
        var titleRect = titleLabel?.frame ?? .zero
        let activityIndicatorRect = getActivityIndicatorRect(forContentRect: contentRect)
