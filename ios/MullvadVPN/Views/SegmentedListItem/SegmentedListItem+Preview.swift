...
#Preview("Settings") {
    ...
    VStack(spacing: 0) {
        ...
        SegmentedListItem(
            leading: {
                itemFactory.leading(for: .generic(title: "Setting - close"))
            },
            trailing: {
        ...
        SegmentedListItem(
            leading: {
                itemFactory.leading(for: .generic(title: "Setting - drilldown"))
            },
            trailing: {
        ...
        SegmentedListItem(
            leading: {
                itemFactory.leading(for: .generic(title: "Setting - external"))
            },
            trailing: {
        ...
        SegmentedListItem(
            leading: {
                itemFactory.leading(
                    for: .generic(title: "Setting - input", subtitle: inputText.isEmpty ? "Input value" : inputText)
                )
            },
            trailing: {
                itemFactory.trailing(
        ...
        SegmentedListItem(
            leading: {
                itemFactory.leading(for: .generic(title: "Setting - toggle", subtitle: toggleState ? "On" : "Off"))
            },
            trailing: {
                itemFactory.trailing(
