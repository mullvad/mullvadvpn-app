...
class AccountInputGroupView: UIView {
    ...
    private func updateLastUsedAccountConstraints(isExpanded: Bool, animated: Bool) {
        let actions = {
            let deactivateConstraint: NSLayoutConstraint
            let activateConstraint: NSLayoutConstraint

            if isExpanded {
                activateConstraint = self.lastUsedAccountVisibleConstraint
                deactivateConstraint = self.lastUsedAccountHiddenConstraint
            } else {
                activateConstraint = self.lastUsedAccountHiddenConstraint
                deactivateConstraint = self.lastUsedAccountVisibleConstraint
            }

            deactivateConstraint.isActive = false
