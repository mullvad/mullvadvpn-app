...
class VerifiedAccountView: UIView {
    ...
    private var didRequestToLogOut: (VerifiedAccountView) -> Void
    ...
    init(didRequestToLogOut: @escaping (VerifiedAccountView) -> Void) {
