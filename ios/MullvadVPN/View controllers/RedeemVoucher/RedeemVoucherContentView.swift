...
final class RedeemVoucherContentView: UIView {
    ...
    private func addConstraints() {
        NSLayoutConstraint.activate([
            voucherCodeStackView.topAnchor.constraint(equalTo: layoutMarginsGuide.topAnchor),
            voucherCodeStackView.leadingAnchor.constraint(equalTo: layoutMarginsGuide.leadingAnchor),
            voucherCodeStackView.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor),
            ...
            actionsStackView.leadingAnchor.constraint(equalTo: layoutMarginsGuide.leadingAnchor),
            actionsStackView.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor),
            actionsStackView.bottomAnchor.constraint(equalTo: layoutMarginsGuide.bottomAnchor),
        ])
    }
    ...
    private func updateUI() {
        ...
        redeemButton.isEnabled = isEnabledRedeemButton && textField.isSatisfiedVoucherLength
