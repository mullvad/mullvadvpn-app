...
class ChipCollectionView: UIView {
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(ChipViewCell.self, forCellWithReuseIdentifier: cellReuseIdentifier)
...
extension ChipCollectionView: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        let cell = collectionView.dequeueReusableCell(
            ...
            for: indexPath
        ) as! ChipViewCell // swiftlint:disable:this force_cast
        cell.configuration = chips[indexPath.row]
        return cell
    }
}
