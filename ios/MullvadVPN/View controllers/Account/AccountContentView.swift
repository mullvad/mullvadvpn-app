...
class AccountContentView: UIView {
    let purchaseButton: InAppPurchaseButton = {
        ...
        button.setTitle(
            NSLocalizedString("Add time", comment: ""),
            for: .normal
        )
        return button
    }()
    ...
    let storeKit2PurchaseButton: AppButton = {
        ...
        button.setTitle(
            NSLocalizedString("Make a purchase with StoreKit2", comment: ""),
            for: .normal
        )
        return button
    }()
    ...
    let storeKit2RefundButton: AppButton = {
        let button = AppButton(style: .success)
        button.setTitle(
            NSLocalizedString("Refund last purchase with StoreKit2", comment: ""),
            for: .normal
        )
        return button
    }()
    ...
    let redeemVoucherButton: AppButton = {
        ...
        button.setTitle(
            NSLocalizedString("Redeem voucher", comment: ""),
            for: .normal
        )
        return button
    }()
