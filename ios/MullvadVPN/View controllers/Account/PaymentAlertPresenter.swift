...
class PaymentAlertPresenter {
    ...
    func showAlertForError(
        ...
        let alertController = CustomAlertViewController(
            title: error.getDisplayErrorTitle(context: context),
            message: error.displayErrorDescription
        )

        alertController.addAction(
            title: getOkButtonTextWithKey("PAYMENT_ERROR_ALERT_OK_ACTION"),
            style: .default,
            handler: {
                completion?()
            }
    ...
    func showAlertForResponse(
        ...
        alertController.addAction(
            title: getOkButtonTextWithKey("PAYMENT_RESPONSE_ALERT_OK_ACTION"),
            style: .default,
            handler: {
                completion?()
            }
    ...
    private func getOkButtonTextWithKey(_ key: String) -> String {
