    ...
    var body: some View {
        ...
        HStack {
            ...
            Button {
                ...
                let icon: Image =
                    if hasFilters {
                        automaticMultihopIsActive ? .mullvadIconFilterCutoutDisabled : .mullvadIconFilterCutout
                    } else {
                        automaticMultihopIsActive ? .mullvadIconFilterDisabled : .mullvadIconFilter
                    }
