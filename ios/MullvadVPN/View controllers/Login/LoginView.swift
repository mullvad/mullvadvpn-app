...
extension LoginView {
    ...
    private var buttonContainer: some View {
        VStack(spacing: 20) {
            MullvadButton(text: "Login", style: .success, action: viewModel.login)
    ...
    private var textFieldContainer: some View {
        // Creating a variable prevents the placeholder from being localized.
        ...
        return VStack(alignment: .leading, spacing: 4) {
            ...
            ConfigurableTextField(
                ...
                borderStyle: $viewModel.textFieldBorderStyle,
                configuration: .init(
    ...
    private var createAccountAlert: MullvadAlert {
        MullvadAlert(
            ...
            messages: [
                ...
                LocalizedStringKey("Do you want to create a new account?"),
            ],
            actions: [
                .init(
                    type: .primary,
