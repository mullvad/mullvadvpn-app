...
struct PreferencesViewModel: Equatable {
    ...
    func merged(_ other: PreferencesViewModel) -> PreferencesViewModel {
        ...
        mergedViewModel.customDNSDomains = mergeAndFilter(customDNSDomains, with: other.customDNSDomains)
    ...
    private func mergeAndFilter(_ oldDomains: [DNSServerEntry], with newDomains: [DNSServerEntry]) -> [DNSServerEntry] {
