...
final class NotificationBannerView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            actionButton.leadingAnchor.constraint(equalTo: bodyLabel.trailingAnchor, constant: UIMetrics.inAppBannerActionButtonPadding * -1),
            actionButton.topAnchor.constraint(equalTo: bodyLabel.topAnchor, constant: UIMetrics.inAppBannerActionButtonPadding * -1),
            actionButton.trailingAnchor.constraint(equalTo: wrapperView.layoutMarginsGuide.trailingAnchor, constant: UIMetrics.inAppBannerActionButtonPadding),
            actionButton.widthAnchor.constraint(equalToConstant: UIMetrics.inAppBannerActionButtonSize.width),
            actionButton.heightAnchor.constraint(equalToConstant: UIMetrics.inAppBannerActionButtonSize.height),
        ])
    }
