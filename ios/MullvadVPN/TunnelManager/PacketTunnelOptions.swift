...
struct PacketTunnelOptions {
    ...
    private enum Keys: String {
        /// Option key that holds the `NSData` value with `RelaySelectorResult` encoded using
        // `JSONEncoder`.
        ...
        /// Option key that holds the `NSNumber` value, which is when set to `1` indicates that the
        // tunnel was started by
        /// the system.
