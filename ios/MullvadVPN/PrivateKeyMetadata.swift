...
struct PrivateKeyMetadata {
    ...
    var publicKeyMetadata: PublicKeyMetadata {
        return PublicKeyMetadata(publicKey: privateKey.publicKey, createdAt: creationDate)
    }
...
struct PublicKeyMetadata: Equatable {
...
extension PrivateKeyMetadata: Codable {
