...
class MaskedInputFormatter: NSObject, UITextFieldDelegate, UITextPasteDelegate {
    ...
    let allowedInput: AllowedInput
    let groupSeparator: GroupSeparator
    let shouldUseAllCaps: Bool
    ...
    init(allowedInput: AllowedInput, groupSeparator: GroupSeparator, shouldUseAllCaps: Bool) {
        self.allowedInput = allowedInput
        self.groupSeparator = groupSeparator
        self.shouldUseAllCaps = shouldUseAllCaps
