...
class PreferencesDataSource: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let sectionIdentifier = snapshot.section(at: indexPath.section)!
        let sectionItems = snapshot.items(in: sectionIdentifier)
    ...
    func tableView(_ tableView: UITableView, targetIndexPathForMoveFromRowAt sourceIndexPath: IndexPath, toProposedIndexPath proposedDestinationIndexPath: IndexPath) -> IndexPath {
        let sectionIdentifier = snapshot.section(at: sourceIndexPath.section)!

        if case .customDNS = sectionIdentifier {
    ...
    private func registerCells() {
        tableView?.register(SettingsSwitchCell.self, forCellReuseIdentifier: ReuseIdentifiers.settingSwitch.rawValue)
        ...
        tableView?.register(SettingsStatusCell.self, forCellReuseIdentifier: ReuseIdentifiers.settingStatus.rawValue)
    ...
    private func dequeueCellForItem(_ item: Item, in tableView: UITableView, at indexPath: IndexPath) -> UITableViewCell {
        ...
        case .blockAdvertising:
            ...
            if isEditing {
                let cell = tableView.dequeueReusableCell(withIdentifier: ReuseIdentifiers.settingSwitch.rawValue, for: indexPath) as! SettingsSwitchCell
                ...
                let cell = tableView.dequeueReusableCell(withIdentifier: ReuseIdentifiers.settingStatus.rawValue, for: indexPath) as! SettingsStatusCell
