...
use mullvad_types::{
    ...
    relay_constraints::{BridgeSettings, BridgeConstraints, BridgeState, Constraint, LocationConstraint, RelayConstraintsUpdate, RelaySettings, RelaySettingsUpdate, TunnelProtocol,
        OpenVpnConstraints,
            ...
            RelaySettingsUpdate::Normal(RelayConstraintsUpdate {
                ...
                tunnel_protocol: settings.tunnel_type.map(|update| {
                    match update.tunnel_type {
                        ...
                        x if x == proto::TunnelType::Openvpn as i32 => Constraint::Only(TunnelProtocol::OpenVpn),
                        x if x == proto::TunnelType::Wireguard as i32 => Constraint::Only(TunnelProtocol::Wireguard),
                        _ => unreachable!("unknown protocol"),
                    }
                }),
        ...
        RelaySettings::Normal(constraints) => {
            relay_settings::Endpoint::Normal(proto::NormalRelaySettings {
                ...
                tunnel_type: match constraints.tunnel_protocol {
                    ...
                    Constraint::Only(TunnelProtocol::Wireguard) => proto::TunnelType::Wireguard as i32,
                    Constraint::Only(TunnelProtocol::OpenVpn) => proto::TunnelType::Openvpn as i32,
                },
...
pub struct ManagementInterfaceServer {
    ...
    _server_abort_tx: triggered::Trigger,
...
impl ManagementInterfaceServer {
    ...
    pub fn start(tunnel_tx: DaemonCommandSender) -> Result<Self, Error> {
        ...
        Ok(ManagementInterfaceServer {
            ...
            runtime,
            _server_abort_tx: server_abort_tx,
