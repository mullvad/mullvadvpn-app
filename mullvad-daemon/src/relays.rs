...
impl RelaySelector {
    ...
    /// If all of the relays have a weight of 0, one will be picked at random without bias, otherwise roulette
    /// wheel selection will be used to pick only relays with non-zero weights.
