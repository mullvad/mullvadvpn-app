...
impl AccessModeSelector {
    ...
    fn update_access_methods(&mut self, access_methods: Settings) {
        // It is important to update `self.index` whenever the access method
        // settings changes, since it could lead to unwanted behavior if the
        // index is suddenly greater than the total number of the access method
        // settings.
        //
