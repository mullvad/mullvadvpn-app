...
impl HibernationDetector {
    ...
    fn interactive_session(session_id: u32) -> bool {
        ...
        for logon in logons {
            ...
            let correct_session = unsafe { *session_data }.Session == session_id;
            interactive = unsafe { *session_data }.LogonType == SECURITY_LOGON_TYPE_INTERACTIVE;
