...
fn migrate_api_access_settings(settings: &mut serde_json::Value) -> Result<()> {
    ...
    // "api_access_methods": { "custom": .. } }. Step 2. Collect all of the built-in methods
    // from { "api_access_methods": { "custom": [ .. ] } }. Step 3. Remove all of the built-in
    // methods from { "api_access_methods": { "custom": [ .. ] } }. Step 4. Add the collected
    // built-in methods from step 2 to { "api_access_methods": { .. } } under some appropriate key.
