...
use mullvad_types::{
    ...
    relay_constraints::{
        allowed_ips_to_constraint, BridgeSettings, BridgeState, BridgeType, ObfuscationSettings,
...
pub enum DaemonCommand {
    ...
    SetWireguardAllowedIps(ResponseTx<(), settings::Error>, Vec<IpNetwork>),
...
impl Daemon {
    ...
    async fn on_set_wireguard_allowed_ips(
        ...
        let allowed_ips_constraint = allowed_ips_to_constraint(allowed_ips);
