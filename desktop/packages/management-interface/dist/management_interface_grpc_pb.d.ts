...
interface IManagementServiceService_ISetPersonalVpnConfig extends grpc.MethodDefinition<management_interface_pb.PersonalVpnConfig, management_interface_pb.PersonalVpnConfigError> {
    path: "/mullvad_daemon.management_interface.ManagementService/SetPersonalVpnConfig";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<management_interface_pb.PersonalVpnConfig>;
    requestDeserialize: grpc.deserialize<management_interface_pb.PersonalVpnConfig>;
...
interface IManagementServiceService_ISetPersonalVpnConfigStatus extends grpc.MethodDefinition<google_protobuf_wrappers_pb.BoolValue, google_protobuf_empty_pb.Empty> {
...
interface IManagementServiceService_IGetPersonalVpnStats extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, management_interface_pb.PersonalVpnStats> {
    ...
    requestSerialize: grpc.serialize<google_protobuf_empty_pb.Empty>;
    requestDeserialize: grpc.deserialize<google_protobuf_empty_pb.Empty>;
    responseSerialize: grpc.serialize<management_interface_pb.PersonalVpnStats>;
    responseDeserialize: grpc.deserialize<management_interface_pb.PersonalVpnStats>;
}
...
export interface IManagementServiceClient {
    ...
    setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
    setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
    setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
...
export class ManagementServiceClient extends grpc.Client implements IManagementServiceClient {
    ...
    public setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
    public setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
    public setPersonalVpnConfig(request: management_interface_pb.PersonalVpnConfig, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: management_interface_pb.PersonalVpnConfigError) => void): grpc.ClientUnaryCall;
