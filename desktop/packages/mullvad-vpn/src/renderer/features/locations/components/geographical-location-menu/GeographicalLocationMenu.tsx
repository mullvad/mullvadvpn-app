  ...
  return (
    <>
      <Menu onOpenChange={onOpenChange} {...props}>
        <Menu.Popup>
          {setAsEntryVisible && <SetAsEntryMenuOption location={location} />}
          {setAsExitVisible && <SetAsExitMenuOption location={location} />}
          {(setAsEntryVisible || setAsExitVisible) && <Menu.Divider />}
          <Menu.Title>
            {sprintf(
