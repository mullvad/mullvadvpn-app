...
import {
  CustomListLocationListsProvider,
  useCustomListLocationListsContext,
} from './CustomListLocationListsContext';
...
function CustomListLocationListsImpl() {
  const { addingCustomList } = useCustomListLocationListsContext();
          ...
          {customListLocations.map((customList) => {
            ...
            return (
              <StyledAnimatedListItem key={key}>
                <CustomListLocationList customList={customList} />
...
export function CustomListLocationLists() {
  return (
    <CustomListLocationListsProvider>
      <CustomListLocationListsImpl />
    </CustomListLocationListsProvider>
  );
}
