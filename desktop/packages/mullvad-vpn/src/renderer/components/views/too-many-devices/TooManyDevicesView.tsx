      ...
      <StyledCustomScrollbars fillContainer>
        <View.Content>
          <FlexColumn gap="large">
            <View.Container flexDirection="column" indent="medium">
            ...
            {devices !== undefined && (
              <>
                <View.Container flexDirection="column" indent="medium" gap="small">
            ...
            {devices !== undefined && (
              <View.Container flexDirection="column" indent="medium" gap="medium">
