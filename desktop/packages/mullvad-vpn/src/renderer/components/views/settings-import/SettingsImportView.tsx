      ...
      <BackAction action={history.pop}>
        ...
        <View.Content>
          <View.Container
            ...
            <WarningDialog open={clearDialogOpen} onOpenChange={setClearDialogOpen}>
              <Dialog.Title>
                {messages.pgettext('settings-import', 'Clear all overrides?')}
              </Dialog.Title>
              <Dialog.Text>
              ...
              <Dialog.ButtonGroup>
                <Dialog.Button onClick={confirmClear} variant="destructive">
                  <Dialog.Button.Text>{messages.gettext('Clear')}</Dialog.Button.Text>
                </Dialog.Button>
                <Dialog.CloseButton>
                  <Dialog.CloseButton.Text>{messages.gettext('Cancel')}</Dialog.CloseButton.Text>
                </Dialog.CloseButton>
              </Dialog.ButtonGroup>
            </WarningDialog>
          </View.Container>
