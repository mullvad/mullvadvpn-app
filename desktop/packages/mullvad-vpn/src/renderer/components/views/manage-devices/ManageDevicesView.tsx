...
import { NoDevicesState } from './components';
...
export function ManageDevicesView() {
  ...
  return (
    <ManageDevicesProvider isFetching={isFetching} refetchDevices={refetch}>
          ...
          <NavigationContainer>
            ...
            <NavigationScrollbars>
              <FlexColumn $gap="medium">
                ...
                {showDeviceList && <DeviceList devices={devices} />}
                {!showDeviceList && (
                  <View.Container
                    ...
                    $alignItems="center"
                    $padding={{ bottom: 'tiny' }}>
                    {isLoading ? <Spinner size="big" /> : <NoDevicesState />}
                  </View.Container>
                )}
              </FlexColumn>
            </NavigationScrollbars>
