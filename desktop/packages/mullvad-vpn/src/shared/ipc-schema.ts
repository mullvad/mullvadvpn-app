...
export const ipcSchema = {
  ...
  settings: {
    ...
    setPersonalVpnConfig: invoke<PersonalVpnConfig, SetPersonalVpnConfigError>(),
    setPersonalVpnEnabled: invoke<boolean, void>(),
    clearPersonalVpn: invoke<void, SetPersonalVpnConfigError>(),
    personalVpnStats: notifyRenderer<PersonalVpnStats>(),
  },
  guiSettings: {
