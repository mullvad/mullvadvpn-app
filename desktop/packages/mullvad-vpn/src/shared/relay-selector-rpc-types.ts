...
export type RelaySelectorPredicateEntryConstraints = {
  ...
  antiCensorship: ObfuscationSettings; // TODO: Rename to AntiCensorshipSettings
...
export type RelaySelectorPredicate =
  | {
      singlehop: RelaySelectorPredicateEntryConstraints;
    }
  | {
      autohop: RelaySelectorPredicateEntryConstraints;
    }
  | {
      entry: RelaySelectorPredicateMultihopConstraints;
    }
  | {
      exit: RelaySelectorPredicateMultihopConstraints;
    };
