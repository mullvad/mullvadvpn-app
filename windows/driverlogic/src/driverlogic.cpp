...
void DeleteDevice(HDEVINFO devInfo, const SP_DEVINFO_DATA &devInfoData)
{
...
void DeleteVanillaMullvadAdapter()
{
	...
	ForEachDevice(DEPRECATED_TAP_HARDWARE_ID, [&mullvadGuid](HDEVINFO devInfo, const SP_DEVINFO_DATA &devInfoData) {
		try
		{
