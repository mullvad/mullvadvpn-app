...
const GUID &InboundLayerFromIp(const wfp::IpAddress &ip)
{
	switch (ip.type())
	{
		case wfp::IpAddress::Type::Ipv4: return FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4;
		case wfp::IpAddress::Type::Ipv6: return FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6;
		default:
		{
			THROW_ERROR("Missing case handler in switch clause");
		}
