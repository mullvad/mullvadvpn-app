...
MullvadGuids::DetailedIdentityRegistry MullvadGuids::DetailedRegistry(IdentityQualifier qualifier)
{
	...
	if (IdentityQualifier::OnlyCurrent != (qualifier & IdentityQualifier::IncludeDeprecated))
	{
	...
	if (IdentityQualifier::OnlyCurrent != (qualifier & IdentityQualifier::IncludePersistent))
	{
