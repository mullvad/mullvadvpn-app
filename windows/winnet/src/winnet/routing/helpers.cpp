...
bool IsPhysicalInterface(const MIB_IPFORWARD_ROW2 &route)
{
	...
	for (size_t i = 0; i < sizeof(TUNNEL_INTERFACE_DESCS) / sizeof(TUNNEL_INTERFACE_DESCS[0]); i++)
	{
