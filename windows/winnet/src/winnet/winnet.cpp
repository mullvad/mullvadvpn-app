...
)
{
	...
	catch (const winnet::routing::error::NoDefaultRoute&)
	{
		return WINNET_AR_STATUS_NO_DEFAULT_ROUTE;
	}
	catch (const winnet::routing::error::DeviceNameNotFound&)
	{
		return WINNET_AR_STATUS_NAME_NOT_FOUND;
	}
	catch (const winnet::routing::error::DeviceGatewayNotFound&)
	{
