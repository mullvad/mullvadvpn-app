...
- Add a button to disconnect to unlock the internet, and open a web browser to buy more time, when
  the currently used account runs out of time and a "Block when disconnected" option is engaged.
...
- Fix the bug when the "Buy more time" button, displayed on the "Out of time" view, remained
  disabled unless a user manually disconnected to unlock the internet.
