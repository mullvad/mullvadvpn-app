...
impl From<mullvad_types::relay_constraints::LocationConstraint> for proto::Foo {
...
impl From<proto::Foo> for Constraint<mullvad_types::relay_constraints::LocationConstraint> {
