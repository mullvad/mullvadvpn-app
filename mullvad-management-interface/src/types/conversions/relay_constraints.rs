...
use mullvad_types::{
    ...
    custom_list::Id,
    relay_constraints::{
        allowed_ips_from_strings, allowed_ips_to_constraint, GeographicLocationConstraint,
    },
};
use std::str::FromStr;
    ...
    for mullvad_types::relay_constraints::WireguardConstraints
{
    ...
    fn try_from(
        ...
        let allowed_ips = allowed_ips_to_constraint(
            allowed_ips_from_strings(&constraints.allowed_ips[..]).map_err(|e| {
