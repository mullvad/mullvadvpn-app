...
The scripts generating these icons are
- [Desktop logo script](./gui/scripts/build-logo-icons.sh)
- [Android logo script](./android/generate-pngs.sh)
- [iOS logo/icon script](./ios/convert-assets.rb)
- [Desktop menubar icon script](./gui/scripts/build-menubar-icons.sh)
