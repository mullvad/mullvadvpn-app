...
you want the source code for OpenSSL and a few other projects you should avoid a recursive
...
- **dist-assets/** - Icons, binaries and other files used when creating the distributables
  ...
  - **ca.crt** - The Mullvad relay server root CA. Bundled with the app and only relays
