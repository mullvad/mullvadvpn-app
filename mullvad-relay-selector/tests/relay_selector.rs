...
mod new {
    ...
    // This relay list can be generated by running
    // `mullvad-api --bin relay_list -- --internal > relays.json`
...
mod relay_list_builder {
    ...
    impl RelayListBuilder {
        ...
        pub fn enpoint_data_mut(&mut self) -> &mut WireguardRelayEndpointData {
