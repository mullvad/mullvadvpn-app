...
fn asseble_fragment_ordered(c: &mut Criterion) {
...
fn asseble_fragment_random(c: &mut Criterion) {
    let mut group = c.benchmark_group("fragmentation_reconstruction");
...
criterion_group!(benches, asseble_fragment_ordered, asseble_fragment_random);
