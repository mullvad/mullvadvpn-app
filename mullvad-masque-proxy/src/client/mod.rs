    ...
    let update_max_datagram_size = |max_datagram_size: &mut u16| -> bool {
        ...
        if let Some(new) = quinn_conn.max_datagram_size() {
            ...
            *max_datagram_size = new;
            // TODO: do we need to subtract this?
            //       quinn will prepend the stream id to the datagram, but maybe
            //       max_datagram_size already takes this into account?
            //- stream_id_size; // TODO: checked_sub
        }
