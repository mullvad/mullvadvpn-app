...
impl ErrorStateCause {
    ...
    pub fn prevents_filtering_resolver(&self) -> bool {
        match self {
            Self::FiilteringResolverError | Self::ReadSystemDnsConfig | Self::SetDnsError => true,
            _ => false,
        }
    }
}
...
impl fmt::Display for ErrorStateCause {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let description = match *self {
            ...
            #[cfg(target_os = "macos")]
            FiilteringResolverError => "Failed to set up custom resolver",
            #[cfg(target_os = "macos")]
