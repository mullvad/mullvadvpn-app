...
impl TunnelStateTransition {
    pub fn is_blocked(&self) -> bool {
        match self {
            TunnelStateTransition::Error(error_state) => error_state.is_blocking(),
            _ => false,
        }
    }
}
...
pub struct ErrorState {
    ...
    /// A false value means there was a serious error and the indended security properties are not
    /// being upheld.
    is_blocking: bool,
}
