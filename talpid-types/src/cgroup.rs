...
mod test {
    ...
    fn test_find_net_cls_path() {
        let input = br#"cgroup /sys/fs/cgroup/net_cls,net_prio cgroup rw,nosuid,nodev,noexec,relatime,net_cls,net_prio 0 0
some-garbage-line
"#;
    ...
    fn test_fail_to_find_net_cls_path() {
        let input = br#"cgroup /sys/fs/cgroup/memory cgroup rw,nosuid,nodev,noexec,relatime,memory 0 0
