...
# This is an active probe to distinguish "booted" from "ready" because
# `tunnelState` and `ddiServicesAvailable` stay `"unavailable"`/`false`
# even after the bootState appears.
# ------------------------------------------------------------------------------
device_is_ready() {
   local out
