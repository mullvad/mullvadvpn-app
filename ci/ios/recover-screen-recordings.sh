...
# This script recovers the video by compressing it into the Data store
...
for ((i=0; i<count; i++)); do
  ...
  # Compress the video with zstd and replace the error text data file
  zstd "$video" -o "$data_file" --force -q
