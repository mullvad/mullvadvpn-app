    ...
    return (
      <View style={ containerClass }>
        ...
        {this.props.showSettings ?
          <Button style={ styles.headerbar__settings_button } onPress={ this.props.onSettings } testName="headerbar__settings">
            <Img source='icon-settings' style={ styles.headerbar__settings } />
          </Button>
          : null}
      </View>
    );
