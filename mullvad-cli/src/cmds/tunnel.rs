                    ...
                    clap::SubCommand::with_name("shadowsocks")
                        ...
                        .arg(
                            clap::Arg::with_name("cipher")
                                .help("Specifies the cipher(s) to use")
                                .default_value("chacha20")
                                .possible_values(&["aes-128-cfb", "aes-128-cfb1", "aes-128-cfb8", "aes-128-cfb128",
                                    "aes-256-cfb", "aes-256-cfb1", "aes-256-cfb8", "aes-256-cfb128", "rc4", "rc4-md5",
                                    "chacha20", "salsa20", "chacha20-ietf", "aes-128-gcm", "aes-256-gcm",
                                    "chacha20-ietf-poly1305", "xchacha20-ietf-poly1305",
                                    "aes-128-pmac-siv", "aes-256-pmac-siv"])
                                .index(4),
                        ).arg(
                            clap::Arg::with_name("local-port")
                                .help("Specifies the port Shadowsocks should listen on")
                                .default_value("0")
                                .index(5),
                        ),
                ),
