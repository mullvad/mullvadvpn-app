...
///
/// A plain configuration is represented by proxy type [`super::ProxyType::Plain`]. It expected
/// that the input to this function will come from the last 12 bytes of an IPv6 address. A plain
