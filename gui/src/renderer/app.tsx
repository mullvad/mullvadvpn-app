...
export default class AppRenderer {
  ...
  public deleteSplitTunnelingApplication(application: IWindowsApplication) {
    return IpcRendererEventChannel.windowsSplitTunneling.deleteApplication(application);
  }
