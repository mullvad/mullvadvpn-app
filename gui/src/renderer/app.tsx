...
export default class AppRenderer {
  ...
  public forgetSplitTunnelingApplication(application: IWindowsApplication) {
    return IpcRendererEventChannel.windowsSplitTunneling.forgetApplication(application);
  }
