...
import { BackBarItem, NavigationBar, NavigationContainer, TitleBarItem } from './NavigationBar';
        ...
        <Container>
          <View>
            ...
            <View style={styles.wgkeys__container}>
              ...
              <View style={styles.wgkeys__main}>
                ...
                <View style={styles.wgkeys__row}>
		      <AppButton.GreenButton disabled={this.props.isOffline} onPress={this.props.onVisitWebsiteKey}>
			<AppButton.Label>
