...
interface SelectorWithCustomProps<T, U> extends CommonSelectorProps<T | undefined, U> {
...
export function SelectorWithCustom<T, U>(props: SelectorWithCustomProps<T, U>) {
  const {
    value,
    inputPlaceholder,
    onSelect,
