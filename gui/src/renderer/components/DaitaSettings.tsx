        ...
        <Cell.CellFooter>
          <AriaDescription>
            <Cell.CellFooterText>
              {messages.pgettext(
                'vpn-settings-view',
                'Is automatically enabled with DAITA, makes it possible to use DAITA with any server by using multihop. This might increase latency.',
              )}
            </Cell.CellFooterText>
          </AriaDescription>
        </Cell.CellFooter>
        ...
        <ModalMessage>
          {
            ...
            messages.pgettext(
              'wireguard-settings-view',
              'Not all our servers are DAITA-enabled. In order to use the internet, you might have to select a new location after disabling, or you can continue using DAITA with Smart routing.',
            )
          }
        </ModalMessage>
      </ModalAlert>
