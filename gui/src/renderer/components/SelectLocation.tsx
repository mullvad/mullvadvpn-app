...
export default class SelectLocation extends Component<IProps> {
            ...
            <NavigationContainer>
              ...
              <View style={styles.container}>
                <NavigationScrollbars ref={this.scrollView}>
                  <SpacePreAllocationView ref={this.heightAdditionRef}>
  ...
  private onWillExpand = (locationRect: DOMRect, expandedContentHeight: number) => {
    ...
    this.heightAdditionRef.current?.addHeight(expandedContentHeight);
...
class SpacePreAllocationView extends Component<IHeightAdditionProps> {
