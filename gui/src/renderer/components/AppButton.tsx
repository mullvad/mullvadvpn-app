...
export const RedButton = (props: IProps) => <StyledRedButton as={BaseButton} {...props} />;
export const GreenButton = (props: IProps) => <StyledGreenButton as={BaseButton} {...props} />;
export const BlueButton = (props: IProps) => <StyledBlueButton as={BaseButton} {...props} />;
export const TransparentButton = (props: IProps) => (
  <StyledTransparentButton as={BaseButton} {...props} />
);
export const RedTransparentButton = (props: IProps) => (
  <StyledRedTransparentButton as={BaseButton} {...props} />
);
