...
export function WindowsSplitTunnelingSettings(props: IPlatformSplitTunnelingSettingsProps) {
  const {
    ...
    deleteSplitTunnelingApplication,
  ...
  const deleteApplicationAndUpdate = useCallback(
    async (application: IWindowsApplication) => {
      await deleteSplitTunnelingApplication(application);
      const { applications } = await getWindowsSplitTunnelingApplications();
      setApplications(applications);
    },
    [deleteSplitTunnelingApplication, getWindowsSplitTunnelingApplications],
  );
  ...
  const includedRowRenderer = useCallback(
    (application: IWindowsApplication) => {
      const onDelete = application.deletable ? deleteApplicationAndUpdate : undefined;
      return (
    ...
    [addApplication, deleteApplicationAndUpdate],
  );
