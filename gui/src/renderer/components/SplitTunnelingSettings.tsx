...
export function WindowsSplitTunnelingSettings(props: IPlatformSplitTunnelingSettingsProps) {
  const {
    ...
    forgetSplitTunnelingApplication,
  ...
  const forgetApplicationAndUpdate = useCallback(
    async (application: IWindowsApplication) => {
      await forgetSplitTunnelingApplication(application);
      const { applications } = await getWindowsSplitTunnelingApplications();
      setApplications(applications);
    },
    [forgetSplitTunnelingApplication, getWindowsSplitTunnelingApplications],
  );
  ...
  const includedRowRenderer = useCallback(
    (application: IWindowsApplication) => {
      const onForget = application.deletable ? forgetApplicationAndUpdate : undefined;
      return (
    ...
    [addApplication, forgetApplicationAndUpdate],
  );
