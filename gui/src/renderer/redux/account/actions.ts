...
function loggedIn(deviceConfig: NonNullable<IDeviceConfig>): ILoggedInAction {
  return {
    type: 'LOGGED_IN',
...
function accountCreated(deviceConfig: NonNullable<IDeviceConfig>, expiry: string): IAccountCreated {
  return {
    type: 'ACCOUNT_CREATED',
    accountToken: deviceConfig.accountToken,
    deviceName: deviceConfig.device?.name,
