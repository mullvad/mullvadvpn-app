...
export class ErrorNotificationProvider
  ...
  public getSystemNotification() {
    if (this.context.state !== 'error') {
      throw Error('ErrorNotificationProvider.getSystemNotification() called when no error');
    }
  ...
  public getInAppNotification(): InAppNotification {
    if (this.context.state !== 'error') {
      throw Error('ErrorNotificationProvider.getInAppNotification() called when no error');
    }
    ...
    return {
      ...
      subtitle: getInAppNotificationBody(this.context),
    };
  }
}
