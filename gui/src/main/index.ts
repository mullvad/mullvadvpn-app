...
class ApplicationMain {
  ...
  private evaluateNotificationVisibility = (notification: SystemNotification) => {
    try {
      ...
      return (
        ...
        !this.shouldSuppressNotifications(notification.critical)
      );
    } catch (e) {
      log.error(`Failed to evaluate notification visibility: ${e.message}`);
      return false;
    }
  };
