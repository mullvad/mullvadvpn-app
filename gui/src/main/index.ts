...
class ApplicationMain {
  ...
  private initLogging() {
    ...
    if (process.env.NODE_ENV !== 'development') {
      ...
      log.addOutput(new FileOutput(LogLevels.debug, mainLogPath));
      this.rendererLog.addInput(new IpcInput());
      this.rendererLog.addOutput(new FileOutput(LogLevels.debug, rendererLogPath));
    }

    log.addOutput(new ConsoleOutput(LogLevels.debug));
  }
