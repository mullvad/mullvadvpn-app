...
export default class NotificationController {
      ...
      case 'connecting':
        if (!this.reconnecting) {
          ...
          if (details && details.location && details.location.hostname) {
            ...
            this.showTunnelStateNotification(msg, messages.pgettext('notifications', 'Connecting'));
          } else {
      ...
      case 'connected':
        {
          ...
          if (details.location && details.location.hostname) {
            ...
            this.showTunnelStateNotification(msg, messages.pgettext('notifications', 'Secured'));
          } else {
  ...
  private showTunnelStateNotification(message: string, title: string = '') {
    ...
    const newNotification = new Notification({
      title: this.notificationTitle || title,
      body: message,
      silent: true,
      icon: this.notificationIcon,
    });
