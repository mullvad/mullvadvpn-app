...
describe('Date helper', () => {
  it('should modify minutes', () => {
    ...
    const earlierDate = date.modifyDate(initialDate, date.DateComponent.minute, -50);
    const laterDate = date.modifyDate(initialDate, date.DateComponent.minute, 100);
  ...
  it('should modify hours', () => {
    const initialDate = new Date('2021-01-01 13:37:10');
    const earlierDate = date.modifyDate(initialDate, date.DateComponent.hour, -50);
    const laterDate = date.modifyDate(initialDate, date.DateComponent.hour, 100);
  ...
  it('should modify days', () => {
    const initialDate = new Date('2021-01-01 13:37:10');
    const earlierDate = date.modifyDate(initialDate, date.DateComponent.day, -50);
    const laterDate = date.modifyDate(initialDate, date.DateComponent.day, 100);
