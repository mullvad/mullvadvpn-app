...
export default class NotificationController {
  ...
  _addPendingNotification(notification: Notification) {
    // Quirk: chrome postpones the 'close' event until new notifications pump the queue or window
    // becomes visible. It's possible that there is going to be one stale notification but that
