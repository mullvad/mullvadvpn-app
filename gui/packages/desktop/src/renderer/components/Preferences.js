...
export default class Preferences extends Component<PreferencesProps, State> {
  ...
  constructor(props: PreferencesProps) {
    ...
    props
      .getStartMinimized()
      .then((startMinimized) => this.setState({ startMinimized }))
      .catch((error) => {
        throw error;
      });
  }
                ...
                <NavigationScrollbars>
                  ...
                  <View style={styles.preferences__content}>
                    ...
                    <StartMinimizedToggle
                      ...
                      onChange={this._onChangeStartMinimized}
                    />
                  </View>
                </NavigationScrollbars>
              </View>
  ...
  _onChangeStartMinimized = (startMinimized: boolean) => {
    this.props.setStartMinimized(startMinimized);
    this.setState({ startMinimized });
  };
}
