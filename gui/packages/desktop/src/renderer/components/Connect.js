...
import { Accordion, IpAddressLabel, SecuredLabel, SecuredDisplayStyle } from '@mullvad/components';
...
class TunnelControl extends Component<{
  ...
  render() {
    ...
    const Ip = () => <IpAddressLabel style={styles.status_ipaddress} value={this.props.ip || ''} />;
