...
const ApplicationMain = {
  ...
  _cachedUserLocation: (null: ?Location),
  ...
  async _updateLocation(oldState: TunnelStateTransition) {
    ...
    if (
      ...
      try {
        ...
        if (newState.state === 'disconnected' && this._cachedUserLocation) {
          this._setLocation(this._cachedUserLocation);
        }
        ...
        if (location.hostname === null) {
          this._cachedUserLocation = location;
        }
