...
function generate_ico() {
    ...
    for size in 16 32 48; do
        local notification_icon_size=$((size / 4))
...
function generate() {
    ...
    generate_png "$svg_source_path" "$macos_target_path.png" \
        "${macos_target_path}_notification.png" 22 3 4
    generate_png "$svg_source_path" "$macos_target_path@2x.png" \
        "${macos_target_path}_notification@2x.png" 44 6 8

    # MacOS monochrome
    generate_png "$black_svg_source_path" "${macos_target_path}Template.png" \
        "${macos_target_path}_notificationTemplate.png" 22 3 4
    generate_png "$black_svg_source_path" "${macos_target_path}Template@2x.png" \
        "${macos_target_path}_notificationTemplate@2x.png" 44 6 8

    # Linux colored
    local linux_target_path="$LINUX_DIR/$icon_name"
    generate_png "$svg_source_path" "$linux_target_path.png" \
        "${linux_target_path}_notification.png" 48 8 10

    # Linux white
    generate_png "$white_svg_source_path" "${linux_target_path}_white.png" \
        "${linux_target_path}_white_notification.png" 48 8 10
