...
describe('components/Settings', () => {
  ...
  it('should show out-of-time message for unpaid account', () => {
    ...
    const component = getComponent(shallow(<Settings {...props} />), 'settings__account_paid_until_subtext');
  ...
  it('should call account callback', (done) => {
    ...
    const component = getComponent(shallow(<Settings {...props} />), 'settings__account_paid_until_button');
    component.simulate('press');
  });
