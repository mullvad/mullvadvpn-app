...
pub enum Error {
    ...
    #[error(display = "Failed to set nonblocking flag on UDP socket")]
    SetNonblockingSocket(#[error(source)] io::Error),

    #[error(display = "Failed to random send data through UDP socket")]
