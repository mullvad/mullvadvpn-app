...
pub enum Error {
    ...
    /// Unknown error while starting the wireguard tunnel.
    #[error(display = "Unknown error while starting wireguard tunnel - {}", status)]
    UnknownStartWireguardError { status: i32 },
