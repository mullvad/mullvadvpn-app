...
use talpid_types::net::ConnectivityInfo;
...
pub struct BroadcastListener {
    ...
    _notify_tx: Arc<UnboundedSender<ConnectivityInfo>>,
}
...
impl BroadcastListener {
    pub async fn start(
        notify_tx: UnboundedSender<ConnectivityInfo>,
    ...
    pub async fn host_is_offline(&self) -> ConnectivityInfo {
...
struct SystemState {
    connectivity: ConnectivityInfo,
    notify_tx: Weak<UnboundedSender<ConnectivityInfo>>,
}
...
pub async fn spawn_monitor(
    sender: UnboundedSender<ConnectivityInfo>,
    route_manager_handle: RouteManagerHandle,
