...
pub enum Error {
    ...
    #[error(display = "Failed to start eslogger")]
    StartMonitor(#[error(source)] io::Error),
    /// Failed to list processes
    #[error(display = "Failed to list processes")]
    InitializePids(#[error(source)] io::Error),
    /// Failed to find path for a process
    #[error(display = "Failed to find path for a process: {}", _0)]
