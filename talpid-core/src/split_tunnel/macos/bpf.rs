...
pub enum Error {
    ...
    #[error(display = "Failed to open BPF device")]
    OpenBpfDevice(#[error(source)] io::Error),
    /// No free BPF device found
    #[error(display = "No free BPF device found")]
    NoFreeBpfDeviceFound,
    /// Interface name too long
    #[error(display = "Interface name too long")]
    InterfaceNameTooLong,
    /// IOCTL failed
    #[error(display = "IOCTL failed")]
    IoctlFailed(#[error(source)] io::Error),
    /// Failed to get flags for BPF device
    #[error(display = "Failed to get flags for BPF device")]
    GetFileFlags(#[error(source)] io::Error),
    /// Failed to set flags for BPF device
    #[error(display = "Failed to set flags for BPF device")]
    SetFileFlags(#[error(source)] io::Error),
    /// Failed to create AsyncFd
    #[error(display = "Failed to create AsyncFd")]
    AsyncFd(#[error(source)] io::Error),
}
