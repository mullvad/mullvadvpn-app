...
impl IphlpApi {
    fn new() -> Result<Self, Error> {
        ...
        // This function is loaded dynamically for compatibility with Windows 10 earlier
        // than build 19041 (version 2004).
        // TODO: This can be replaced with a direct call to
        // `windows_sys::...::SetInterfaceDnsSettings` once we drop support for Windows 10 <2004
