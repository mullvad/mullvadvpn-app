use crate::logging::windows::{LogSink, log_sink};
...
impl super::DnsMonitorT for DnsMonitor {
    ...
    fn new(cache_dir: impl AsRef<Path>) -> Result<Self, Error> {
        let logging_context = "WinDns" as *const _ as *mut c_void;
        unsafe { WinDns_Initialize(Some(log_sink), logging_context).into_result()? };
