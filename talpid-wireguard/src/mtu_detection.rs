...
pub enum Error {
    ...
    #[error(display = "Failed to detect MTU because all pings timed out.")]
    ...
    MtuDetectionUnexpected(#[error(source)] surge_ping::SurgeError),
...
mod tests {
    ...
    proptest! {
        ...
        fn mtu_spacing_properties(mtu_min in 0..800u16, mtu_max in 800..2000u16, step_size in 1..800u16)  {
            ...
            // The spacing should be no grated than step size
