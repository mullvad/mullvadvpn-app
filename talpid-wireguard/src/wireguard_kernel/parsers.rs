...
/// Parse a WireGuard handshake timestamp. The resulting [SystemTime] is a timestamp relative to
/// [SystemTime::UNIX_EPOCH].
pub fn parse_timespec(buffer: &[u8]) -> Result<SystemTime, DecodeError> {
    // Note: The 64-bit UAPI time type is used for the WireGuard handshake timestamp,
