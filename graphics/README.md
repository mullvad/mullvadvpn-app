...
The `icon-ios.svg` is used to generate Android's square icon used in the app's Google Play Store
...
```
rsvg-convert ./icon-ios.svg -w 512 -h 512 -o ../android/src/main/play/listings/en-US/graphics/icon/icon.png
```
